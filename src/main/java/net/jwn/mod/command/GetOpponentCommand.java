        ...
        if (command.getSource().getEntity() instanceof Player player) {
            if (pTargets.size() != 1) {
                ...
                if (opponent == null) {
                    ...
                    player.sendSystemMessage(Component.translatable("message.mod_players_2.get_opponent_not_in_game"));
                } else {
                    player.sendSystemMessage(
                            Component.translatable("message.mod_players_2.get_opponent",
